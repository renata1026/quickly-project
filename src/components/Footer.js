      ...
      <div className='px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8'>
        <div className='grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4 text-white'>
          <div className='sm:col-span-2'>
            ...
            <div className='mt-6 lg:max-w-sm'>
              <p className='mt-4 text-sm text-white'>
                Get started with Quickly for free. No credit card required.
              </p>
            </div>
          </div>
          <div className='space-y-2 text-sm'>
            ...
            <div className='flex'>
              ...
              >
                Suite 202 838-11th Avenue SW, Calgary, AB, T2R 0E5
              </a>
            </div>
          </div>
          <div>
        ...
        <div className='flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row'>
          <p className='text-sm text-white'>
            © Copyright 2023 Quickly All rights reserved.
          </p>
